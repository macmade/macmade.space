                        ...
                        <div class="col-sm-4 offset-md-1 py-4">
                            ...
                            <ul class="list-unstyled">
                                <li>
                                    ...
                                    <a href="https://www.astrobin.com/users/macmade/" class="text-white">Astrobin</a>
                                </li>
                                <li>
                                    <i class="bi bi-instagram"></i>
                                    <a href="http://instagram.com/macmade/" class="text-white">Instagram</a>
                                </li>
                                <li>
                                    <i class="bi bi-mastodon"></i>
                                    <a href="https://mastodon.social/@macmade" class="text-white">Mastodon</a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <section class="py-5 text-center container">
                <div class="row">
                    <div class="col-lg-6 col-md-8 mx-auto">
                        ...
                        <h2 class="fw-light">Astrophotography</h2>
                    </div>
                </div>
            </section>
